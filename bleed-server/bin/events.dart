...
void _onCharacterDeath(Character character) {
  if (character is Npc) {
    if(true || randomBool()){
      ...
      particles.add(Particle(character.x, character.y, character.xVel + giveOrTake(5), character.yVel + giveOrTake(5), randomInt(30, 45), randomRadion(), randomBetween(0.7, 0.95), ParticleType.Arm, giveOrTake(0.125)));
      particles.add(Particle(character.x, character.y, character.xVel + giveOrTake(5), character.yVel + giveOrTake(5), randomInt(30, 45), randomRadion(), randomBetween(0.7, 0.95), ParticleType.Arm, giveOrTake(0.125)));
      particles.add(Particle(character.x, character.y, character.xVel + giveOrTake(5), character.yVel + giveOrTake(5), randomInt(30, 45), randomRadion(), randomBetween(0.7, 0.95), ParticleType.Organ, giveOrTake(0.125)));

...
List<double> getSrcSkillType(SkillType skillType) =>
    switch (skillType) {
      ...
      SkillType.Bludgeon => const [_srcX, iconSizeSkillType * 4],
      ...
      SkillType.Agility => const [768, 64],
      SkillType.Vampire => const [416, 576, 32, 32],
      SkillType.Warlock => const [416, 768, 32, 32],

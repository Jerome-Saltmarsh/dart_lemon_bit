...
const _armor_robe = const [srcx_armor, 64.0];
const _armor_cloak = const [srcx_armor, 64.0];

const atlasSrcAmuletItem = <AmuletItem, List<double>> {
  AmuletItem.Weapon_Staff_1_Common: [srcx_weapon_staff, 0],
  AmuletItem.Weapon_Staff_1_Rare: [srcx_weapon_staff, 0],
  AmuletItem.Weapon_Staff_1_Legendary: [srcx_weapon_staff, 0],
  AmuletItem.Weapon_Sword_1_Common: [srcx_weapon_sword, 0],
  AmuletItem.Weapon_Sword_1_Rare: [srcx_weapon_sword, 0],
  AmuletItem.Weapon_Sword_1_Legendary: [srcx_weapon_sword, 0],
  AmuletItem.Weapon_Bow_1_Common: [srcx_weapon_bow, 0],
  AmuletItem.Weapon_Bow_1_Rare: [srcx_weapon_bow, 0],
  AmuletItem.Weapon_Bow_1_Legendary: [srcx_weapon_bow, 0],

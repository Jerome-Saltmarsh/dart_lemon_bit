...
import 'package:amulet_flutter/isometric/consts/map_projectile_type_to_emission_ambient.dart';
    ...
    for (var i = 0; i < nodeLightSourcesTotal; i++){
      ...
      switch (nodeType) {
        ...
        case NodeType.Fireplace:
          emitLight(
            index: nodeIndex,
            value: colors.orange_0.withOpacity(0.5).value,
        ...
        case NodeType.Torch_Red:
          emitLight(
            index: nodeIndex,
            value: colors.red_1.withOpacity(0.5).value,
            intensity: torchEmissionIntensityColored,
            ambient: false,
          );
          break;

...
class AtlasItems {
  ...
  static double getSrcX(int itemType) =>
      ...
      const <int, double> {
        ...
        ItemType.Buff_Invincibility: 512,
        ItemType.Buff_No_Recoil: 480,
        ItemType.Buff_Run_Fast: 480,
        ...
        ItemType.Weapon_Ranged_Plasma_Rifle: 674,
  ...
  static double getSrcY(int itemType) =>
      const <int, double>{
        ...
        ItemType.Buff_Invincibility: 96,
        ItemType.Buff_No_Recoil: 64,
        ItemType.Buff_Run_Fast: 96,
        ...
        ItemType.Weapon_Ranged_Plasma_Rifle: 771,
  ...
  static double getSrcWidth(int itemType) =>
      const <int, double>{
        ...
        ItemType.Weapon_Ranged_Plasma_Rifle: 349,

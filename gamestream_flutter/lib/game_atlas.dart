...
class AtlasItems {
  ...
  static double getSrcX(int itemType) =>
      ...
      const <int, double> {
        ...
        ItemType.Weapon_Ranged_Plasma_Rifle: 320,
        ...
        ItemType.Weapon_Ranged_Plasma_Pistol: 321,
  ...
  static double getSrcY(int itemType) =>
      const <int, double>{
        ...
        ItemType.Weapon_Ranged_Shotgun: 331,
        ...
        ItemType.Weapon_Ranged_Plasma_Rifle: 160,
        ...
        ItemType.Weapon_Ranged_Plasma_Pistol: 134,
  ...
  static double getSrcWidth(int itemType) =>
      const <int, double>{
        ...
        ItemType.Weapon_Ranged_Plasma_Pistol: 30,
  ...
  static double getSrcHeight(int itemType) => const <int, double>{
        ...
        ItemType.Weapon_Ranged_Sniper_Rifle: 44,
        ItemType.Weapon_Ranged_Bazooka: 108,
        ...
        ItemType.Weapon_Ranged_Plasma_Pistol: 25,

...
class ClientQuery {
  ...
  static int getHoverItemType() =>
      gamestream.isometric.serverState.getItemTypeAtInventoryIndex(gamestream.isometric.clientState.hoverIndex.value);

  static Watch<int> mapKeyboardKeyToWatchBeltType(LogicalKeyboardKey key){
    if (key == LogicalKeyboardKey.digit1)
       return gamestream.isometric.serverState.playerBelt1_ItemType;
     if (key == LogicalKeyboardKey.digit2)
       return gamestream.isometric.serverState.playerBelt2_ItemType;
    if (key == LogicalKeyboardKey.digit3)
      return gamestream.isometric.serverState.playerBelt3_ItemType;
    if (key == LogicalKeyboardKey.digit4)
      return gamestream.isometric.serverState.playerBelt4_ItemType;
    if (key == LogicalKeyboardKey.keyQ)
      return gamestream.isometric.serverState.playerBelt5_ItemType;
    if (key == LogicalKeyboardKey.keyE)
      return gamestream.isometric.serverState.playerBelt6_ItemType;

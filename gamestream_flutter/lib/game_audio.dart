...
class GameAudio {
  ...
  static final MapItemTypeAudioSinglesAttackMelee = <int, AudioSingle> {
    ...
    ItemType.Weapon_Handgun_Glock: dagger_woosh_9,
    ItemType.Weapon_Smg_Mp5: dagger_woosh_9,
    ItemType.Weapon_Handgun_Desert_Eagle: dagger_woosh_9,
    ItemType.Weapon_Handgun_Revolver: dagger_woosh_9,
    ...
    ItemType.Weapon_Rifle_Jager: dagger_woosh_9,
    ItemType.Weapon_Rifle_AK_47: dagger_woosh_9,
    ItemType.Weapon_Rifle_M4: dagger_woosh_9,
    ItemType.Weapon_Rifle_Sniper: dagger_woosh_9,
    ItemType.Weapon_Ranged_Shotgun: dagger_woosh_9,
    ItemType.Weapon_Flamethrower: dagger_woosh_9,
    ItemType.Weapon_Special_Bazooka: dagger_woosh_9,

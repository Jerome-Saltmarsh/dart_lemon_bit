...
double get mouseGridX => convertWorldToGridX(mouseWorldX, mouseWorldY) + GameState.player.z;
double get mouseGridY => convertWorldToGridY(mouseWorldX, mouseWorldY) + GameState.player.z;

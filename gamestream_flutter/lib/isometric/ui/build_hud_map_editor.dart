...
const editorSelectableGridTypes = [
    ...
    NodeType.Fireplace,
    NodeType.Wood,
    NodeType.Wood_Half_Row_1,
    NodeType.Wood_Half_Row_2,
    NodeType.Wood_Half_Column_1,
    NodeType.Wood_Half_Column_2,
    NodeType.Wood_Corner_Top,
    NodeType.Wood_Corner_Right,
    NodeType.Wood_Corner_Bottom,
    NodeType.Wood_Corner_Left,
    NodeType.Water,
    NodeType.Water_Flowing,
    NodeType.Tree_Top,
    NodeType.Tree_Bottom,
    NodeType.Grass_Slope_North,
    NodeType.Grass_Slope_East,
    NodeType.Grass_Slope_South,
    NodeType.Grass_Slope_West,
    ...
    NodeType.Stone,
    NodeType.Grass_Slope_Top,
    NodeType.Grass_Slope_Right,
    NodeType.Grass_Slope_Bottom,
    NodeType.Grass_Slope_Left,
    NodeType.Grass_Edge_Top,
    NodeType.Grass_Edge_Right,
    NodeType.Grass_Edge_Bottom,
    NodeType.Grass_Edge_Left,
    NodeType.Bau_Haus,

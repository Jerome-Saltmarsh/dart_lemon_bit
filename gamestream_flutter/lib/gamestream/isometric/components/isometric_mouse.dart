...
class IsometricMouse {
  ...
  static int get nodeIndex => gamestream.isometric.scene.getNodeIndex(positionX, positionY, positionZ);
  ...
  static bool get inBounds {
    return !gamestream.isometric.scene.outOfBoundsXYZ(positionX, positionY, positionZ);
  }
}
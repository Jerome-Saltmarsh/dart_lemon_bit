...
class IsometricMouse {
  ...
  static int get nodeIndex => gamestream.isometric.getIndexXYZ(positionX, positionY, positionZ);
  ...
  static bool get inBounds {
    return !gamestream.isometric.outOfBoundsXYZ(positionX, positionY, positionZ);
  }
}
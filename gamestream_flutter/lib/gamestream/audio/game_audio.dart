...
class GameAudio {
  ...
  double getVolumeTargetDayAmbience() {
    final hours = gamestream.isometric.hours.value;
  ...
  double getVolumeTargetWind() {
    final windLineDistance = (gamestream.engine.screenCenterRenderX - gamestream.isometric.windLineRenderX).abs();
    final windLineDistanceVolume = convertDistanceToVolume(windLineDistance, maxDistance: 300);
    var target = 0.0;
    if (gamestream.isometric.windLineRenderX - 250 <= gamestream.engine.screenCenterRenderX) {
      target += windLineDistanceVolume;
    }
    final index = gamestream.isometric.windTypeAmbient.value;
    if (index <= WindType.Calm) {
      if (gamestream.isometric.hours.value < 6) return target;
      if (gamestream.isometric.hours.value < 18) return target + 0.1;
      return target;
    }
  ...
  double getVolumeTargetCrickets() {
    final hour = gamestream.isometric.hours.value;
    const max = 0.8;
  ...
  late final MapItemTypeAudioSinglesAttack = <int, AudioSingle> {
     ...
     WeaponType.Crowbar: dagger_woosh_9,
     WeaponType.Sword: dagger_woosh_9,
     WeaponType.Pistol: revolver_shot_3,
     WeaponType.Plasma_Pistol: revolver_shot_6,
     WeaponType.Plasma_Rifle: assault_rifle_shot_14,
     WeaponType.Smg: pistol_shot_07,
     WeaponType.Revolver: revolver_shot_3,
     WeaponType.Musket: assault_rifle_shot_14,
     WeaponType.Rifle: assault_rifle_shot_14,
     WeaponType.Machine_Gun: assault_rifle_shot_14,
     WeaponType.Sniper_Rifle: sniper_shot_4,
     WeaponType.Shotgun: shotgun_shot,
     WeaponType.Flame_Thrower: fire_bolt_14,
     WeaponType.Bazooka: fire_bolt_14,
     WeaponType.Minigun: machine_gun_shot_02,
  ...
  late final MapItemTypeAudioSinglesAttackMelee = <int, AudioSingle> {
    ...
    WeaponType.Crowbar: dagger_woosh_9,
    WeaponType.Sword: dagger_woosh_9,
    WeaponType.Pistol: dagger_woosh_9,
    WeaponType.Handgun: dagger_woosh_9,
    WeaponType.Smg: dagger_woosh_9,
    WeaponType.Revolver: dagger_woosh_9,
    WeaponType.Musket: dagger_woosh_9,
    WeaponType.Rifle: dagger_woosh_9,
    WeaponType.Machine_Gun: dagger_woosh_9,
    WeaponType.Sniper_Rifle: dagger_woosh_9,
    WeaponType.Shotgun: dagger_woosh_9,
    WeaponType.Flame_Thrower: dagger_woosh_9,
    WeaponType.Bazooka: dagger_woosh_9,

...
enum GameError {
  ...
  Parent_Talent_Required_To_Unlock, Talent_Max_Level, Selected_Mark_Index_Not_Set, Invalid_Mark_Stack_Index, Insufficient_Element_Points, Insufficient_Elements, Weapon_Rack_Full;

...
const _weapons_bow_reflex = [srcx_weapon_bow, 32.0];
const _weapons_bow_composite = [srcx_weapon_bow, 64.0];
const _weapons_bow_long = [srcx_weapon_bow, 96.0];
...
List<double> getSrcAmuletItem(AmuletItem amuletItem) =>
    switch (amuletItem) {
      ...
      AmuletItem.Weapon_Bow_Reflex => _weapons_bow_reflex,
      AmuletItem.Weapon_Bow_Composite => _weapons_bow_composite,
      AmuletItem.Weapon_Bow_Long => _weapons_bow_long,
      ...
      AmuletItem.Shoes_Sabatons => _shoes_grieves,
      ...
      AmuletItem.Special_Weapon_Assassins_Blade => _weapons_sword_short,
      AmuletItem.Special_Weapon_Flame_Wand => _weapons_wand,
      AmuletItem.Special_Weapon_Frost_Wand => _weapons_wand,

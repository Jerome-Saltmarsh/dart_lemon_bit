...
class AmuletApp extends StatelessWidget {
  ...
  void checkForLatestVersion() async {
    ...
    operationStatus.value = OperationStatus.Checking_For_Updates;
    // engine.refreshPage();
  }
  ...
  Widget buildPageWebsiteDesktop(BuildContext context) {
    return Container(
      ...
      child: WatchBuilder(serverMode, (ServerMode serverMode) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (serverMode == ServerMode.local)
                          buildWatch(connection, (connection) {
          ...
          WebsitePage.New_Character => Stack(
            ...
            children: [
              DialogCreateCharacterComputer(
                app: this,
                createCharacter: connection.value?.createNewCharacter ?? (throw Exception()),
  ...
  Widget buildTogglePlayMode() {
    return WatchBuilder(serverMode, (activeServerMode) {
      return Container(
        width: 500,
        child: Row(
          ...
          children: [...ServerMode.values.map((serverMode) {
            return onPressed(
              action: () => this.serverMode.value = serverMode,
              child: Container(
                alignment: Alignment.center,
                width: 80,
                height: 30,
          ...
          child: Column(
              children: characters
                ...
                return Row(
                  ...
                  children: [
                    onPressed(
                      action: () => connection.value?.playCharacter(uuid),
                      child: Container(
                          alignment: Alignment.center,
                          width: 360,
                          color: Colors.white12,
